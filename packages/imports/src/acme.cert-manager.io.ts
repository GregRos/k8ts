...
export function toJson_ChallengeSpecSolverDns01Route53AuthKubernetes(
    ...
    const result = {
        serviceAccountRef: toJson_ChallengeSpecSolverDns01Route53AuthKubernetesServiceAccountRef(
...
export function toJson_ChallengeSpecSolverHttp01GatewayHttpRoutePodTemplateSpec(
    ...
    const result = {
        affinity: toJson_ChallengeSpecSolverHttp01GatewayHttpRoutePodTemplateSpecAffinity(
            obj.affinity
        ),
...
export function toJson_ChallengeSpecSolverHttp01IngressPodTemplateSpec(
    ...
    const result = {
        ...
        priorityClassName: obj.priorityClassName,
        securityContext: toJson_ChallengeSpecSolverHttp01IngressPodTemplateSpecSecurityContext(
            obj.securityContext
        ),
        serviceAccountName: obj.serviceAccountName,
        tolerations: obj.tolerations?.map(y =>
...
export function toJson_ChallengeSpecSolverHttp01IngressPodTemplateSpecAffinity(
    ...
    const result = {
        nodeAffinity: toJson_ChallengeSpecSolverHttp01IngressPodTemplateSpecAffinityNodeAffinity(
            obj.nodeAffinity
        ),
...
export function toJson_ChallengeSpecSolverHttp01IngressPodTemplateSpecSecurityContext(
    ...
    const result = {
        ...
        supplementalGroups: obj.supplementalGroups?.map(y => y),
        sysctls: obj.sysctls?.map(y =>
            toJson_ChallengeSpecSolverHttp01IngressPodTemplateSpecSecurityContextSysctls(y)
        )
    }
    // filter undefined values
    return Object.entries(result).reduce(
